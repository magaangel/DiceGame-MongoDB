...
import com.mongodicegame.repository.IgameRepository;
import com.mongodicegame.repository.IplayerRepository;
...
public class PlayerService implements IplayerService{
    ...
    public Game addGameRollDice(Long idPlayer) {
        ...
        if(game.getId() == 0){
            ...
            game.setIdPlayer(idPlayer);
            game.setDice1(dice1);
            game.setDice2(dice2);
            game.setResultRollDice(resultRollDices);
        }
        game = gameRepository.save(game);//se crea un objeto partida (game)
